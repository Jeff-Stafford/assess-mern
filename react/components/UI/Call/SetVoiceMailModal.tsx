...
interface SetVoiceMailModalProps {
	show?: boolean;
	onClose?: () => void;
}

const SetVoiceMailModal: FC<SetVoiceMailModalProps> = ({ show, onClose }) => {
	...
	const redirectToSetCellAction = async () => {
		window.open('/user-settings/voicemail', '_blank');
		if (onClose !== undefined) {
			onClose();
		}
	};
					...
					<div className="flex justify-center items-center h-screen px-4 py-14 text-center">
						...
						>
							<div className="mb-2 text-center">
								<p className="font-semibold text-xl leading-tight">Please configure your default voicemail.</p>
							</div>
...
export default SetVoiceMailModal;
